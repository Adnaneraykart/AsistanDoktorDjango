...
from sklearn.ensemble import RandomForestClassifier  # RandomForest import edilmiştir
...
def main():
    ...
    for fold, (train_index, val_index) in enumerate(kf.split(X), 1):
        ...
        plt.grid(True)
        plt.savefig(f'randomforest_roc_curve_fold_{fold}.png')
        plt.close()
    ...
    plt.savefig("randomforest_test_results_table_stylish.png", format="png", bbox_inches='tight', dpi=300)
    ...
    plt.savefig("randomforest_shap_summary_plot.png", format="png", bbox_inches="tight")  # PNG formatında kaydet
    plt.close()  # Görseli kapat
